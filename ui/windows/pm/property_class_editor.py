...
class PmPropertyClassEditor(wx.Dialog):
    @db_session
    def __init__(self, parent, o=None, _type="CREATE"):
        super().__init__(parent, title="Добавить класс свойств", size=wx.Size(300, 400))
    ...
    def _on_save(self, event):
        ...
        if self._type == "CREATE":
            self.o = PmPropertyClass(**_fields)
        else:
            self.o = PmPropertyClass[self._target.RID]
            self.o.set(**_fields)
        commit()
