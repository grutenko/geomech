...
class DialogCreateMineObject(wx.Dialog):
    def __init__(self, parent, o = None):
        ...
        label = wx.StaticText(colpane_pane, label="X")
        table_sizer.Add(label, 0)
        label = wx.StaticText(colpane_pane, label="Y")
        table_sizer.Add(label, 0)
        label = wx.StaticText(colpane_pane, label="Z")
        table_sizer.Add(label, 0)
    ...
    def _on_save(self, event):
        ...
        fields['coord_system'] = self.field_coord_system.GetValue()
